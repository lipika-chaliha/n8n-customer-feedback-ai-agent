...
Validate the end-to-end customer feedback workflow, including form submission, AI analysis, sentiment generation, personalized responses, email delivery, Google Sheets storage, data integrity and duplicate prevention.
...
| TC-010 | Re-run the same workflow | Workflow behaves consistently without unintended duplicate records | Pass |
...
The main QA focus is **data flow integrity across multiple workflow branches and integrations**.
